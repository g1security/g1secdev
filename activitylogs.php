...
<link rel="shortcut icon" type="image/png" href="g1logo.png"/>
  ...
  <title>User Monitoring | G1 Security</title>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="regusers.php" class="nav-link"><i class="nav-icon fas fa-users"></i>
                <p>
                  Registered Users
                </p>
              </a>
...
<div class = "card">
 ...
 <div class="card-body">
                <table id="tblAttendance" class="table table-bordered table-striped table-hover text-nowrap">
                  <thead>
                  <tr>
                    <th>Clock In</th>
                    <th>User ID</th>
